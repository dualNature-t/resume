    ...
    <ActiveContext.Provider value={{ active }}>
      <div className="index_container">
        <div
          ...
          style={{
            transform: `translateY(${-(active - 1) * windowHeight}px)`,
        ...
        <div id="index_menu">
          <div
            className={classnames("index_menuBtn", { open: modalShow })}
          ...
          <ul className="index_navList">
            {menuData.map((item) => {
              return (
                <li
                  key={item.id}
                  className={classnames("index_navItem", {
