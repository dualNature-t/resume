...
const PageFour = (): JSX.Element => {
  ...
  return (
    <div
      className={classnames("pageFour_container", {
        active: active == steps.four,
      })}
    >
      <div className="pageFour_content">
        <div className="pageFour_nav">
          <div className="pageFour_experienceBox">
            ...
            <div className="pageFour_year">2022</div>
        ...
        <div className="pageFour_item">
          <div className="pageFour_time">
            2022 <span>04月</span>
          </div>
          <div className="pageFour_detail">
            <h3>数支（武汉）互联科技有限公司</h3>
            <p className="pageFour_department">&lt;开发部/前端工程师&gt;</p>
            <p className="pageFour_work">
              参与公司调研类自研产品的开发，涉及产品有Profile、Market、SignUp、官网、合约交易系统、内部管理系统。2023年4月底离职。
            </p>
          </div>
        </div>
        ...
        <div className="pageFour_item">
          ...
          <div className="pageFour_detail">
            <h3>武汉达之云计算有限公司</h3>
            <p className="pageFour_department">&lt;研发部/前端工程师&gt;</p>
            <p className="pageFour_work">
              主导公司视频创作、视频发布类产品的开发。Saas端基于阿里云底座实现视频的一键批量混剪，客户端基于Electron实现视频的多平台一键发布。2026年2月底离职。
            </p>
          </div>
        </div>
